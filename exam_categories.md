...
Classification of every numbered problem across the 11 final-exam papers in
...
2a/2b/2c/…) are counted separately. **Total exercises classified: 189.**
...
| 2  | ER → relational mapping                           | 7  |
| 3  | ER critique (errors in given diagram)             | 2  |
| 4  | SQL `SELECT` queries                              | 12 |
| 5  | SQL DML / DDL                                     | 4  |
| 6  | Relational algebra                                | 8  |
| 7  | Functional dependencies & keys                    | 11 |
| 8  | Normal-form determination                         | 5  |
| 9  | Normalization decomposition                       | 2  |
| 10 | Decomposition properties (lossless / FD pres.)    | 5  |
| 11 | B+-trees (construction & sizing)                  | 11 |
| 12 | Hashing (extendible & static)                     | 12 |
| 13 | Index access paths / query block-cost             | 22 |
| 14 | Join algorithm cost                               | 4  |
| 15 | External sorting                                  | 1  |
| 16 | Heap file / storage layout                        | 1  |
| 17 | Conflict serializability                          | 5  |
| 18 | Recoverability classification                     | 9  |
| 19 | Two-phase locking (2PL)                           | 13 |
| 20 | Isolation levels / snapshot isolation             | 4  |
| 21 | ARIES — Analysis phase                            | 9  |
| 22 | ARIES — Redo phase                                | 6  |
| 23 | ARIES — Undo phase                                | 3  |
| 24 | ARIES — conceptual / true-false                   | 5  |
| 25 | Conceptual / theory short-answer                  | 11 |
| 26 | Comment placeholder (0 pts, end of paper)         | 6  |
...
D2019 #4, D2019_K #5, D2019_K #6, D2020 #4, D2020 #5, D2024 #11.
...
### 7. Functional dependencies & keys — 11
Reasoning about FDs: derive new FDs (Armstrong), compute attribute closure
`X+`, find candidate / superkeys, infer missing tuple values from F, or
upper-bound the number of legal tuples.
*Example:* D2018 #3c — prove `WX → Z` from `WY → Z` and `X → Y`.

Members: D2018 #3a, D2018 #3b, D2018 #3c, D2018_K #8, D2018_K #9, D2018_K #11,
D2019_K #8, D2020 #8, D2020 #9, D2023 #1, D2024 #12.
...
D2023 #8, D2023_K #2, D2024 #1, D2025 #1, D2025 #2.
...
D2023_K #3, D2024 #8, D2025 #3, D2025 #4, D2025 #5.
...
Members: D2021 #15, D2022 #7, D2023_K #10, D2024 #9, D2025 #6.
...
D2021 #11, D2022 #6, D2023 #15, D2023 #16, D2024 #3, D2025 #9, D2025 #10.
...
### 26. Comment placeholder (0 pts) — 6
...
Members: D2021 #17, D2022 #13, D2023 #19, D2023_K #13, D2024 #16, D2025 #15.
